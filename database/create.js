// Description: Script de création des données de test dans la base de données

import * as database from "./database.js";

// Créer des auteurs via le DAO auteursDAO.createAuteur('Nom', 'Prénom')
...
// Création des genres via le DAO genresDAO.createGenre('Nom')
...
// Création des livres via le DAO livresDAO.createLivre('Titre', 'Date', id_auteur, id_genre)
